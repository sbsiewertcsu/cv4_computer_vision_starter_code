...
void FaceDetector::removeFaces(Mat input, Mat output) {
	...
	faceCascadeClassifier.detectMultiScale(frameGray, faces, 1.1, 2, 0 | CV_HAL_CMP_GE, Size(120, 120));
...
Rect getFaceRect(Mat input) {
	...
	faceCascadeClassifier.detectMultiScale(inputGray, faceRectangles, 1.1, 2, 0 | CV_HAL_CMP_GE, Size(120, 120));
